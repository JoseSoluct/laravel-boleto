...
class Sicredi extends AbstractAPI
{
    ...
    {
        if ($this->version !== 3.8) {
            throw new ValidationException('Somente Versão 3.8 da Api homologada');
        }
    ...
    {
        if ($this->version != 3.8) {
            throw new ValidationException('Somente versão 3.8 API recupera boleto pelo nosso id');
        }
    ...
    {
        if ($this->version != 3.8) {
            throw new ValidationException('Somente versão 3.8 API permite busca de PDF');
        }
    ...
    {
        return BoletoSicredi::fromAPI($boleto, [
            'conta'        => $this->getConta(),
